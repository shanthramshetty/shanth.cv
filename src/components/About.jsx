        ...
        <div className="grid grid-cols-1 lg:grid-cols-[2fr_3fr] gap-12 lg:gap-20 items-start">
          ...
          <div>
            ...
            <motion.p {...fade(0.2)} style={{
              fontSize: '0.78rem', color: 'var(--color-text-tertiary)', letterSpacing: '0.05em',
            ...
            <motion.p {...fade(0.28)} style={{
              fontSize: '0.925rem', color: 'var(--color-text-secondary)', lineHeight: 1.85,
            ...
            <motion.div {...fade(0.36)} className="about-stats">
              <div>
                <p style={{
                  ...
                  color: 'var(--color-text-tertiary)', fontWeight: 600, marginBottom: '0.65rem',
                  fontFamily: "'Inter', sans-serif",
                }}>
                  Day job
                </p>
                <p style={{ fontSize: '0.875rem', color: 'var(--color-text-primary)', lineHeight: 1.75, fontFamily: "'Inter', sans-serif" }}>
                  Currently, I am a <strong style={{ fontWeight: 600, color: 'var(--color-text-primary)' }}>Product Designer at 7EDGE</strong>.
