...
const SHOWCASE = [
  {
    ...
    description: 'Finance teams were losing 40% of their working day moving data between disconnected tools — not making decisions, just transferring information that should already have been connected. Restructured the IA around decision moments, not data display.',
    tags: ['SaaS Design', 'Fintech', 'Web + Mobile'],
    metric: { value: '63%', label: 'Faster task completion · 12 usability sessions' },
    accent: '#2B7FFF',
  ...
  },
  {
    ...
    description: 'The problem wasn\'t convenience — it was trust. Users needed to know the slot was actually available and the price was real before committing. Designed and built end-to-end in Flutter; every interaction was justified against that single promise.',
    tags: ['Mobile', 'Product Design', 'Consumer'],
    metric: { value: '4.6★', label: 'App Store rating · launch week' },
    accent: '#22c55e',
  ...
  },
  {
    ...
    description: 'PMs were spending 3–4 hours per PRD on structure and formatting, not thinking. Designed an AI-assisted interface that handles the scaffolding so the thinking stays human. The constraint: output had to feel authored, not generated.',
    tags: ['AI Tool', 'Product', 'B2B'],
    metric: { value: '80%', label: 'Reduction in PRD drafting time' },
    accent: '#a78bfa',
  ...
  },
  {
    ...
    description: 'Five product teams building the same UI patterns independently — each slightly different, each creating debt. Led the architecture of a shared system with a contribution model so teams added back rather than forked. The real outcome wasn\'t components. It was alignment.',
    tags: ['System Design', 'B2B', 'Enterprise'],
    metric: { value: '200+', label: 'Components · 50% faster handoff' },
    accent: '#f59e0b',
