...
const PROJECTS = [
  {
    ...
    video: eventuroxDemo,
    tagline: 'The digital home for an experiential events agency — designed to show, not just tell, what 15 years of concerts and corporate events looks like.',
    overview: 'Event U Rox is an experiential events agency that plans and runs large-scale corporate events, conferences, trade shows, brand activations, and concerts for enterprise clients like TCS, Oracle, Amazon, Airbus, and Bosch — but their old website didn\'t reflect any of that. I designed a new site that leads with visual proof over claims: a bold, editorial "Featured" section puts real event photography front and center, backed by a scrollable showcase of past work, with services organised into clear categories (MICE, exhibitions, brand activations, artist management) so enterprise buyers can quickly find what\'s relevant to them.',
    ...
    metrics: [
      ...
      { value: '75+', label: 'Brand clients featured' },
      { value: '3,500+', label: 'Past experiences represented' },
    ],
    accent: '#f59e0b',
  },
  {
